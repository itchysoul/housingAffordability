...
abbrev_table = """State Name	USPS Abbreviation	Traditional Abbreviation
Alabama	AL	Ala.
Alaska	AK	Alaska
Arizona	AZ	Ariz.
Arkansas	AR	Ark.
...
lines = abbrev_table.split('\n')
state_codes = [l.split('\t')[1] for l in lines[1:]]

assert len(state_codes) == 50
print('state codes parsed')
